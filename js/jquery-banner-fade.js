;(function($){
	...
	$.fn.bannerfade = function(options){
...
//				从哪走
				...
				// 	opacity:0
				// })
				// this.img.eq(iNow).css({
				// 	opacity:0
				// }).css({
				// 	opacity:1
				// })
				this.img.eq(this.index).fadeOut();
				this.img.eq(iNow).fadeIn();
...
//				根据this.list判断
				...
				this.img.eq(this.iPrev).fadeOut();
				this.img.eq(this.index).fadeIn();
